...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menu_file_open_fb = QAction(MainWindow)
        self.menu_file_open_fb.setObjectName(u"menu_file_open_fb")
        self.menu_file_open_ig = QAction(MainWindow)
        self.menu_file_open_ig.setObjectName(u"menu_file_open_ig")
        ...
        self.tools.addAction(self.menu_tools_reduce)
        ...
        self.menu_file_open.triggered.connect(MainWindow.action_menu_file_open)
        ...
        self.menu_file_open_fb.triggered.connect(MainWindow.action_menu_file_open_fb)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_help.setText(QCoreApplication.translate("MainWindow", u"N\u00e1pov\u011bda programu", None))
#if QT_CONFIG(tooltip)
        self.menu_help.setToolTip(QCoreApplication.translate("MainWindow", u"Z\u00edskejte informace o  programu.", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.menu_help.setShortcut(QCoreApplication.translate("MainWindow", u"F1", None))
#endif // QT_CONFIG(shortcut)
        ...
        self.menu_file_open_fb.setText(QCoreApplication.translate("MainWindow", u"Otev\u0159\u00edt Facebook", None))
        self.menu_file_open_ig.setText(QCoreApplication.translate("MainWindow", u"Otev\u0159\u00edt Instagram", None))
