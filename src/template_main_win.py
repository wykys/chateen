...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabwidget_main = QTabWidget(self.splitter)
        ...
        self.table_chats = QTableWidget(self.tab)
        ...
        self.table_participants = QTableWidget(self.tab_2)
        ...
        self.splitter.addWidget(self.tabwidget_main)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabwidget_main.setTabText(self.tabwidget_main.indexOf(self.tab), QCoreApplication.translate("MainWindow", u"Chaty", None))
        self.tabwidget_main.setTabText(self.tabwidget_main.indexOf(self.tab_2), QCoreApplication.translate("MainWindow", u"\u00da\u010dastn\u00edci", None))
        ...
        self.groupBox_3.setTitle(QCoreApplication.translate("MainWindow", u"P\u0159isp\u011bt na olt\u00e1\u0159 v\u011bdy", None))
