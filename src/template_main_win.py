...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menu_file_open1 = QAction(MainWindow)
        self.menu_file_open1.setObjectName(u"menu_file_open1")
        ...
        self.file.addAction(self.menu_file_open1)
        ...
        self.menu_file_open1.triggered.connect(MainWindow.callback_menu_file_open)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menu_file_open1.setText(QCoreApplication.translate("MainWindow", u"Otev\u0159\u00edt", None))
#if QT_CONFIG(shortcut)
        self.menu_file_open1.setShortcut(QCoreApplication.translate("MainWindow", u"Ctrl+O", None))
#endif // QT_CONFIG(shortcut)
